/**
 * Pause Screen for multiplayer
 */
function multiplayerPauseScreen(){
  ...
  this.mousePressed = function(){
    if(game || start){
      ...
      currentGame = this.sceneManager.findScene(multiplayerScene).oScene;
    }
